...
if(!isc.isAn.Array(_1))_1=[_1];isc.DMI.callBuiltin({methodName:"messagingSend",callback:"isc.Messaging.$zv(data)",arguments:[{type:"send",sendToChannels:_1,subscribedChannels:this._channels,data:_2}],requestParams:isc.addProperties({showPrompt:false,callback:_3,willHandleError:_3!=null},_4)})},isc.A.$zv=function isc_c_Messaging__sendCallback(_1){},isc.A.getSubscribedChannels=function isc_c_Messaging_getSubscribedChannels(){return isc.getKeys(this._channels)},isc.A.subscribe=function isc_c_Messaging_subscribe(_1,_2,_3,_4,_5){if(!isc.hasOptionalModules("RealtimeMessaging")&&!this.isRemoteDebug){this.logWarn("RealtimeMessaging not licensed - refusing to subscribe()");return}
...
if(this.getSubscribedChannels().length==0)return;this.$159v=false;var _1=isc.HiddenFrame.create({useHtmlfile:isc.Browser.isIE});this.$zs=_1.getID();this.$1125();var _2={type:"connect",connectionID:this.$zs,subscribedChannels:isc.Comm.serialize(this._channels)};var _3=isc.URIBuilder.create(isc.Page.getURL(this.messagingURL));_3.setQueryParam("ts",isc.timestamp());_3.setQueryParam("isc_noLog","1");if(isc.Messaging.$1129){isc.Messaging.$1129=false;_3.setQueryParam("disconnectUponConnect","true")}
