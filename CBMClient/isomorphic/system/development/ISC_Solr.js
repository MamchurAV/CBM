...
if(_1.facetQueries){for(var _9 in _1.facetQueries){var _10=_1.facetQueries[_9];for(var i=0;i<_10.length;i++){var _11=_10[i];if(!_3[this.facetQueryParam])_3[this.facetQueryParam]=[];_3[this.facetQueryParam].add(_11)}}}
if(_1.filterQueries){if(isc.isAn.Array(_1.filterQueries)){_3[this.filterQueryParam]=_1.filterQueries}else{var _12=[];for(var _13 in _1.filterQueries){_12.add(_13+":"+_1.filterQueries[_13])}
_3[this.filterQueryParam]=_12}}
...
_6.add(_10)}
_1.data=_6;if(_3.facet_counts){_1.facetCounts=_3.facet_counts;_1.facetQueries=_3.facet_counts.facet_queries;_1.facetFields=_3.facet_counts.facet_fields;_1.facetDates=_3.facet_counts.facet_dates;_1.facetRanges=_3.facet_counts.facet_ranges}
...
return _2},isc.A.$1224=function isc_HGridFacetPicker__deselectFacet(_1){this.suppressChart=true;this.facetDeselected(_1);this.suppressChart=false});isc.B._maxIndex=isc.C+8;isc.defineClass("VGridFacetPicker","ListGrid","FacetPicker");isc.A=isc.VGridFacetPicker.getPrototype();isc.B=isc._allFuncs;isc.C=isc.B._maxIndex;isc.D=isc._funcClasses;isc.D[isc.C]=isc.A.Class;isc.A.showHeader=false;isc.A.facetLimit=10;isc.A.maxHeight=200;isc.A.showEmptyMessage=false;isc.A.facetPickerExpanded=true;isc.A.filterQueries={};isc.A.chartDefaults={width:500,height:500,chartType:"Pie",showEdges:true,backgroundColor:"#FFFFFF",showTitle:false};isc.A.autoFitFieldWidths=true;isc.A.autoFitWidthApproach="both";isc.A.autoFitFieldsFillViewport=false;isc.A.selectionAppearance="checkbox";isc.A.leaveScrollbarGap=false;isc.A.isGrouped=true;isc.A.groupByField="title";isc.A.defaultFields=[{name:"value",width:"*",formatCellValue:function(_1,_2){if(_1!=null&&_2.count!=null){_1=_1+" ("+_2.count+")"}
return _1}},{name:"title",showIf:"false"}];isc.B.push(isc.A.initWidget=function isc_VGridFacetPicker_initWidget(){this.groupStartOpen=this.facetPickerExpanded?"all":"none";this.Super("initWidget",arguments)},isc.A.selectionChanged=function isc_VGridFacetPicker_selectionChanged(_1,_2){if(this.$1272)return;if(_2){this.facetSelected(_1.facet,_1.value);this.deselectOtherValues(_1)}else{this.$1224(_1.facet)}},isc.A.deselectOtherValues=function isc_VGridFacetPicker_deselectOtherValues(_1){var _2=this.data.findAll("facet",_1.facet),_3=this;this.$1272=true;_2.map(function(_4){if(_4.value!=_1.value){_3.deselectRecord(_4)}});this.$1272=false;this.markForRedraw()},isc.A.setFacets=function isc_VGridFacetPicker_setFacets(_1){this.facets=_1},isc.A.updateFacetData=function isc_VGridFacetPicker_updateFacetData(_1){if(!_1){this.setData([]);return}
