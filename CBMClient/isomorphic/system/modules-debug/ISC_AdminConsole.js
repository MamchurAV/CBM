...
isc.A.showDataSourceNavigator=false;
isc.B.push(isc.A.initWidget=function isc_AdminConsole_initWidget(){
        ...
        this.databaseBrowser=this.createAutoChild("databaseBrowser",{autoFetchData:false,showHeader:false,canDragPosition:false,canDragResize:true,width:"100%"});
        this.schedulerManager=this.createAutoChild("schedulerManager",{autoFetchData:false});
        this.otherTools=isc.HTMLPane.create({
            width:"100%",
            height:"100%",
            contents:'<ul><li><a href="/tools/visualBuilder/index.jsp" target="_blank">Visual Builder</a></li><li><a href="/tools/bmmlImporter.jsp" target="_blank">Reify Mockup Importer</a></li><li><a href="/tools/batchDSGenerator.jsp" target="_blank">Batch DataSource Generator</a></li></ul>'
        });
        ...
        this.tabSelected=function(tabNum,tabPane,ID,tab,name){
            History.addHistoryEntry(tab.ID);
        };
        ...
        var selectTabByHistoryId=function(){
            var requestedTab=History.getCurrentHistoryId();
            if(requestedTab){
        ...
        History.registerCallback(selectTabByHistoryId);
    }
);
...
,isc.A.setDBFormDefaults=function isc_DBForm_setDBFormDefaults(){
        ...
        if(!driverInterface){
            if(dbType=='oracle'||dbType=='mysql'||dbType=='sqlserver'||
                dbType=='db2')
            {
