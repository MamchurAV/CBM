...
isc.RichTextCanvas.addMethods({
    ...
    //> @attr richTextCanvas.useDesignMode (Boolean : false : IRA)
    ...
    parentResized : function () {
        if (this.parentElement) {
            this.setWidth(this.parentElement.getInnerContentWidth());
            this.setHeight(this.parentElement.getInnerContentHeight());
        }
    },
...
isc.RichTextEditor.addProperties({
    ...
    //> @attr richTextEditor.defaultControlConstructor (SCClassName : "RibbonButton" : IRA)
    ...
    // SmartClient class.
    //<
    defaultControlConstructor: "RibbonButton",
    ...
    // @value "strikethroughSelection" A button to strike through the current selection.
        ...
        isc.addProperties(properties,
            {
                ...
                items: [
                    isc.addProperties({
                        ...
                        pickListProperties: {
                            // don't do this - it isn't necessary and doesn't scale
                            //cellHeight: 16,
...
isc.RichTextItem.addProperties({
    ...
    //> @attr richTextItem.defaultValue (String : null : IRW)
    // Overridden to assign class-appropriate type.
    // @see formItem.defaultValue
    // @group basics
    // @visibility external
    //<
