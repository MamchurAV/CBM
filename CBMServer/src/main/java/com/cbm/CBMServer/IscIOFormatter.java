...
//import com.fasterxml.jackson.core.databind.module.SimpleModule;
...
import com.cbm.CBMMeta.Criteria;
import com.cbm.CBMMeta.CriteriaComplex;
import com.cbm.CBMMeta.CriteriaItem;
import com.cbm.CBMUtils.JSONUniquePropertyPolymorphicDeserializer;
...
public class IscIOFormatter implements I_ClientIOFormatter {
	...
	public DSTransaction formatRequest(RoutingContext request) throws Exception
	{
        ...
        String reqStr = request.body().asString(); // <<<
		if (reqStr == null){
	...
	public String formatResponse(DSResponse dsResponse, DSRequest dsRequest)  throws Exception
	{
		...
		if (dsResponse.retCode >= 0) { // -- Successful response ---
			if (dsRequest.operationType.equals("fetch")) {
				...
				List<Map<String, Object>> dataRows = dsResponse.dataRows;
				if (dataRows != null) {
					int length = 0;
